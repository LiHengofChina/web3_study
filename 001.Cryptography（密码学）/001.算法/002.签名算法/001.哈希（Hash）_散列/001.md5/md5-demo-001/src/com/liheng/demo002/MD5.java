...
public class MD5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(MD5.md5crypt("a" + MD5.md5crypt("a") + "201"));
		System.out.println(MD5.md5crypt("1" + MD5.md5crypt("1") + "201"));
		System.out.println(MD5.md5crypt("李恒"+ MD5.md5crypt("李恒") + "201"));
		...
		System.out.println(DigestUtils.md5Hex("李恒"+ DigestUtils.md5Hex("李恒") + "201"));
	}
}
