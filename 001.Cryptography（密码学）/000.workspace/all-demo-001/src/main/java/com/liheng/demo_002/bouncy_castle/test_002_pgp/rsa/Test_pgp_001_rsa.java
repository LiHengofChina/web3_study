package com.liheng.demo_002.bouncy_castle.test_002_pgp.rsa;
...
public class Test_pgp_001_rsa {
    ...
    public static void main(String[] args) {
        try {
            ...
            // （1） 从文件中读取公钥
            PGPPublicKey publicKey = readPublicKey("pgp/rsa/publicKey.asc");
            // （2） 加密数据
            ...
            // （3） 从文件中读取私钥
            PGPPrivateKey privateKey = readPrivateKey("pgp/rsa/privateKey.asc", "123456".toCharArray()); //
            // （4） 解密数据
